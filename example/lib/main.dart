...
class _CameraExampleHomeState extends State<CameraExampleHome> with WidgetsBindingObserver {
  ...
  TextEditingController _textFieldController = TextEditingController(text: "rtmp://167.99.253.33/stream/test1");
  ...
  Future<String?> startVideoRecording() async {
    ...
    final String filePath = '$dirPath/test1.mp4';

    if(File(filePath).existsSync()) {
      debugPrint("DOSYA VAR. FİLE SİZE = ${File(filePath).lengthSync()}");
    ...
    try {
      ...
      // await controller!.startVideoRecordingAndStreaming(filePath, 'rtmp://167.99.253.33/stream/test1');
    } on CameraException catch (e) {
      _showCameraException(e);
      return null;
    }
