...
class AppVideoEncoder(
    ...
    protected var oldTimeStamp: Long = 0L;
    ...
    private var forceKey: Boolean = false;
    ...
    protected fun checkBuffer(byteBuffer: ByteBuffer,
        ...
        /* FEHMİ TARAFINDAN İLAVE EDİLEN BÖLGE */
        ...
        if (!spsPpsSetted && type.equals(CodecUtil.H264_MIME)) {
            ...
            val byteBufferList: List<ByteBuffer> = extractVpsSpsPpsFromH265(byteBuffer)
        ...
        // FEHMİ İLAVESİ BİTTİ
        /* FEHMİ AŞAĞIDAKİ BÖLÜMÜ KAPATTI
    ...
    // FEWHMİ EKLEDİ
    fun fixTimeStamp(info:MediaCodec.BufferInfo ) {
